...
namespace MyStockViewApp
{
    ...
    public class GoogleFinanceDataBL : IStockDataBusinessLogic
    {
        private string url;
        ...
        public List<StockData> GetStockDetails(string Subscription)
        {
            ...
            try
            {
                ...
                {
                    string googleApi = url + Subscription;
                ...
                while (sLine != null)
                {
                    ...
                    if (sLine != null && sLine.Contains('{'))
                    {
                        ...
                        while (!sLine.Contains('}'))
                        {
                            ...
                            {
                                string[] s = sLine.Split('\"');
                                data.percentChanged = (s[3] == "") ? 0.0f : float.Parse(s[3], CultureInfo.InvariantCulture.NumberFormat);
